...
export default function HomePage() {
  ...
  return (
    <main className="pb-16 pt-6 md:pb-20 md:pt-10">
      <section className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-[radial-gradient(circle_at_top,rgba(38,41,82,0.34),rgba(12,16,19,0.82)_48%),linear-gradient(180deg,rgba(12,16,19,0.9),rgba(12,16,19,0.98))] px-5 py-8 shadow-[0_30px_90px_rgba(0,0,0,0.24)] md:px-10 md:py-12">
        ...
        <div className="relative grid gap-8 lg:grid-cols-[minmax(0,1.2fr)_minmax(320px,0.8fr)] lg:items-end">
          ...
          >
            ...
            <h1
              id="home-hero-title"
              className="mt-5 font-[var(--font-space)] text-4xl font-semibold leading-[0.94] text-white sm:text-5xl md:text-6xl lg:text-7xl"
            >
            ...
            <div className="mt-7 flex flex-col gap-3 sm:flex-row">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="accent-hover rounded-full border border-white/20 bg-white/[0.03] px-6 py-3 text-sm uppercase tracking-[0.14em] text-text"
              >
      ...
      <section id="contatti" className="pb-4 pt-10 md:pb-8 md:pt-14">
        <div className="surface overflow-hidden rounded-[2rem] border-white/12">
          <div className="grid gap-8 px-6 py-8 md:px-10 md:py-10 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end">
            <div>
            ...
            <div className="flex flex-col gap-3 sm:flex-row lg:flex-col">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="accent-hover rounded-full border border-white/20 bg-white/[0.03] px-6 py-3 text-center text-sm uppercase tracking-[0.14em] text-text"
              >
                Contattaci su WhatsApp
              </a>
            </div>
